...
static PartTable def_part_table =
{
...

	{
		...
		end_head: 0xB,
		end_cyl: 0x9F,
		abs_start_sec: 0xf000, //0x7271 // start next block
		sec_in_part:  0x9fff //0xE4E1  // 0x7271 + 0x7270 = 0xe4e1 // eto razmer  2 podrazdelov + 1
	}
};

static unsigned int def_log_part_br_abs_start_sector[] = {0xf000, 0x11000};  // a - abs_start_sec(85 stroka), b = a + razmer vtorogo podradela + 1
